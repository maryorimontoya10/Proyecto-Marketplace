...
-Matplotlib y Seaborn: Gráficos estadísticos y análisis de tendencias.
-Openpyxl y Reportlab: Automatización de reportes ejecutivos en Excel y PDF.

# Archivos del Repositorio

-ProyectoBootcamp.ipynb: Código completo del análisis.
-BD_Marketplace.xlsx: Base de datos comercial (ingresos, comisiones, fechas).
